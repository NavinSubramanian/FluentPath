...
const CourseModule = () => {
    ...
    const fetchModuleData = async () => {
      try {
        const response = await axios.get(
          `https://fluent-path.vercel.app/api/course/${courseId}/module/${moduleId}`,
  ...
  //             `https://fluent-path.vercel.app/api/course/${courseId}/module/${moduleId}/complete`,
  //             {
      ...
      <>
        {section.content && (
          <p
            ...
            className="mainContentCourseHomePage"
          />
        )}
        {section.videoLink && (
          <iframe
    ...
    <>
      ...
      <div className="modulePage">
        ...
        <div className="moduleContent">
          ...
          {sections[activeSection]?.isDeclaration &&
            !sections[activeSection]?.completed && (
              <div
                style={{ marginTop: "-197px" }}
                className="courseDeclarationDiv"
              >
                <input
                  type="checkbox"
                  id="completed"
